...
router.get('/getUserAppointments', apiController.appointment.getUserAppointments);
router.get('/:appointmentid', apiController.appointment.get);

router.delete('/:appointmentid', apiController.appointment.delete);
